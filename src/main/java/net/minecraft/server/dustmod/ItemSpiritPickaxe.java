...
public class ItemSpiritPickaxe extends ItemPickaxe {
   ...
   public boolean onBlockDestroyed(ItemStack var1, int var2, int var3, int var4, int var5, EntityLiving var6) {
         ...
         for(int var10 = -var7; var10 <= var7; ++var10) {
            for(int var11 = -var7; var11 <= var7; ++var11) {
               ...
               if(var13 != null && var13.material == Material.STONE && var13 != Block.BEDROCK) {
                  var13.postBreak(var8, var3 + var9, var4 + var10, var5 + var11, var8.getData(var3 + var9, var4 + var10, var5 + var11));
      ...
      return super.onBlockDestroyed(var1, var3, var4, var5, var2, var6);
   }
}
