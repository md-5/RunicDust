...
public class DEEarthSprite extends PoweredEvent {
   ...
   public void onInit(EntityDust var1) {
      ...
      if(var2[0].count == 0 && var2[1].count == 0 && var2[2].count == 0 && this.takeXP(var1, 25)) {
         for(int var3 = 0; var3 < 8; ++var3) {
            EntityBlock var4 = new EntityBlock(var1.world, (double)var1.getX(), (double)(var1.getY() + 2), (double)var1.getZ(), Block.GLASS.id);
   ...
   public void onTick(EntityDust var1) {
      ...
      EntityHuman var3 = var1.world.a(var1.summonerUN);
      if(var3 != null) {
         ...
         if(var1.genericList.size() > 0) {
            ...
            boolean var6 = var5 == 0.0F && var3.isSneaking() && Math.abs(var3.motY) < 0.08D;
            int var7 = MathHelper.floor(var3.locX);
            int var8 = MathHelper.floor(var3.locY);
            int var9 = MathHelper.floor(var3.locZ);
            if(var6) {
               var3.setPosition((double)var7 + 0.5D, (double)var8 + (double)var3.height - 1.06D, (double)var9 + 0.5D);
               var3.e(0.0F);
            }
            ...
            for(Iterator var10 = var1.genericList.iterator(); var10.hasNext(); ++var4) {
               ...
               if(var6) {
                  ...
                  byte var16 = 60;
                  double var17 = 3.0D;
                  double var19 = (double)((var1.ticksLived + var4 * 8) % var16);
                  double var21 = (double)((var1.ticksLived + var4 * 30) % var16);
                  ...
                  var12.goTo(2.8D, var3.locX + var29, var3.locY + var33, var3.locZ + var31);
               }
            }
         }

         if(var1.ticksLived > 72000) {
            var1.fade();
         }
   ...
   public void onUnload(EntityDust var1) {
      ...
      if(var1.genericList != null) {
         ...
         while(var2.hasNext()) {
            ...
            int var5 = (int)var4.locY;
            int var6 = var5;

            while(true) {
               if(var6 >= 0) {
                  if(var1.world.getTypeId((int)var4.locX, var6, (int)var4.locZ) == 0) {
                     --var6;
                     continue;
                  }
               ...
               var4.setOriginal((int)var4.locX, var5 + 1, (int)var4.locZ);
