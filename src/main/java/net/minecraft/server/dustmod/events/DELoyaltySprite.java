...
public class DELoyaltySprite extends PoweredEvent {
   ...
   public void onTick(EntityDust var1) {
      super.onTick(var1);
      if(var1.data == 0) {
         var1.posY = (double)((float)(var1.getY() - 1) + MathHelper.sin((float)var1.ticksExisted / 16.0F) * 0.5F);
         ...
         while(var3.hasNext()) {
            ...
            if(var4 instanceof EntityLiving && !(var4 instanceof EntityHuman)) {
               ...
               var1.motionX = var1.motionX;
               var1.motionY = var1.motionY;
               var1.motionZ = var1.motionZ;
            }
         }
      } else {
         EntityHuman var8 = var1.worldObj.a(var1.summonerUN);
         if(var8 == null) {
            return;
         }
         ...
         if(var9 instanceof EntityCreature) {
            ...
            if(!var11) {
               if(var8.onGround && var13.getDistanceSqToEntity(var8) > 256.0D) {
                  var13.setLocationAndAngles(var8.posX, var8.posY + (double)var8.yOffset, var8.posZ, 0.0F, 0.0F);
               }
